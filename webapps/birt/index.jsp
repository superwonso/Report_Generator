			...
			<TBODY>
				<TR>
					<TD class=content style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" >
						...
						<p>NetDB Report Generator simulating</p>
						...
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=./cdm_report/abstract_AddPara.rptdesign" %>">Abstract w.Paraments</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=./cdm_report/abstract_2.rptdesign" %>">Instance w.Parameters</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=./cdm_report/log_AddPara.rptdesign" %>">Log w.Parameters</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=./cdm_report/procplan_AddPara.rptdesign" %>">Process Plan w.Parameters</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=./cdm_report/volume_AddPara.rptdesign" %>">Volume w.Parameters</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=./cdm_report/instance_AddPara_insecure.rptdesign" %>">Insecure Test</a>
